...
function buildPolygonRoomShell(group, animState, textureCache, room, wallHeight, floorBaseY, wallColorHex, wallMaterial, center, needsSlabForFloorAbove, sharedRanges) {
 ...
 */
export function rebuildGroup(group, rooms, stairs, wallHeight, wallColor, center, animState, textureCache, wallMaterialDefault = "plaster") {
  ...
  rooms.forEach((r) => {
    ...
    if (r.points) {
      buildPolygonRoomShell(group, animState, textureCache, r, roomWallHeight, floorBaseY, roomWallColor, roomWallMaterial, center, needsSlabForFloorAbove, sharedRanges);
      return;
    }
    ...
    buildRoomRoof(group, animState, textureCache, r, roomWallHeight, floorBaseY, roomWallColor, roomWallMaterial, cx, cz, !!r.has_roof, needsSlabForFloorAbove);
