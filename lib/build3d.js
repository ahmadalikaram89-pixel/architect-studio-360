...
function buildPolygonRoomShell(group, animState, textureCache, room, wallHeight, floorBaseY, wallColorHex, wallMaterial, center, needsSlabForFloorAbove) {
  ...
  for (let i = 0; i < points.length; i++) {
    ...
    buildAngledWallSegment(group, animState, textureCache, wallColorHex, wallMaterial, p1, p2, wallHeight, floorBaseY, center, edgeOpenings);
  }
...
export function rebuildGroup(group, rooms, stairs, wallHeight, wallColor, center, animState, textureCache, wallMaterialDefault = "plaster") {
  ...
  rooms.forEach((r) => {
    ...
    if (r.points) {
      buildPolygonRoomShell(group, animState, textureCache, r, roomWallHeight, floorBaseY, roomWallColor, roomWallMaterial, center, needsSlabForFloorAbove);
      return;
    }
