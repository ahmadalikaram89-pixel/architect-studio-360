...
function buildPolygonRoomShell(group, animState, textureCache, room, wallHeight, floorBaseY, wallColorHex, center) {
...
export function rebuildGroup(group, rooms, stairs, wallHeight, wallColor, center, animState, textureCache) {
  ...
  rooms.forEach((r) => {
    ...
    if (r.points) {
      buildPolygonRoomShell(group, animState, textureCache, r, roomWallHeight, floorBaseY, roomWallColor, center);
      return;
    }
