...
⚠️ **مهم:** حالياً قاعدة البيانات مفتوحة الوصول (بدون تسجيل دخول)، مقبول لمرحلة التجربة فقط. قبل ما تحطي بيانات عملاء حقيقيين لازم نضيف Supabase Auth ونربط كل صف بمستخدم.
...
- **تسجيل دخول (Supabase Auth)** عشان كل مهندس يشوف مشاريعه بس، وتصير قاعدة البيانات مؤمّنة فعلياً مش مفتوحة
